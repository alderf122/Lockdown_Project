...
setpoint_z = 99.95  # La posición deseada en el eje z (puedes ajustar esto según tu configuración)
...
while True:
    ...
    angle_servo_4 = map_value(pid_output, 0.05, -0.05, 82, 78)
    angle_servo_5 = map_value(pid_output, 0.05, -0.05, 98, 102)  
